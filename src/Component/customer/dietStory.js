...
class DietStory extends React.Component {
  ...
  updateAllergen() {
    let sensitive = "";
    if(this.state.profile.q3.allergen.length == 0){
      sensitive += "None";
    } else {
      this.state.profile.q3.allergen.map((allergen => {
        sensitive += `${allergen}, `
      }))
                    ...
                    <div class="pet-overview-card__list">
                      ...
                      <div class={"pet-overview-card__list-item " + this.state.show5[0]}>
                        ...
                        <div class="pet-overview-card__list-item-text ml-4">
                          ...
                          <div class={"pet-overview-card__list-item-value " + this.state.show5[1]}>{this.updateAllergen()}</div></div>
                      </div>
                    </div>
                  </div>
                </div>
