...
// import { Modernizr } from './modernizr.customer'; 


	var support = null;
	var animEndEventNames = null;
	 ...
	 * FForm function
	 */
	export function FForm( el, options, m ) {
		this.Modernizr = m;
		this.el = el;
		...
		animEndEventName = animEndEventNames[ this.Modernizr.prefixed( 'animation' ) ];
	}
	...
	FForm.prototype._nextField = function( backto ) {
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				if( support != null && support.animations ) {
